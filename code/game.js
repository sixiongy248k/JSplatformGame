...
function Coin(pos) { //funky coins???
  var randosize = ((Math.random()*4)+1)*.2;
...
function Spike(pos) {
  ...
  // Make it drop downward like objects
...
Spike.prototype.act = function(step) {
  ...
  this.pos = this.basePos.plus(new Vector(0, wobblePos)); // WIP dropping spikes??
};
...
Player.prototype.moveY = function(step, level, keys) {
  ...
  if(obstacle == "lava"){ //death animation plus respawn at (starting coord)
